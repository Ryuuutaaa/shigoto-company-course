    ...
    <div className="homepage">
      ...
      <div className="kelas w-100 min-vh-100">
        <Container>
          <Row>
            <Col>
              <h1 className="text-center fw-bold">Waifu terbaru</h1>
              ...
              return (
                <Col key={kelas.id} className="shadow">
                  <img
                    src={kelas.image}
                    alt="unplash.com"
                    className="w-100 rounded-top mb-5"
                  />
                  ...
                  <div className="ket d-flex justify-content-between alig-align-items-center px-3 pb-3">
